...
struct MCSConnectInitialPDU: Equatable, Sendable {
    ...
    func encodedClientCoreData() -> Data {
        ...
        // MS-RDPBCGR 2.2.1.3.2: LAN tells xrdp to use RemoteFX / larger tiles
        // instead of painting the desktop as tiny classic bitmaps.
        body.appendUInt8(ClientConnectionType.lan)
