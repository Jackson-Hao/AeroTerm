...
struct RDPClientInfoPDU: Equatable, Sendable {
    ...
    func encodedPDUData() throws -> Data {
        ...
        data.appendLittleEndianUInt32(RDPClientPerformanceFlags.fastPath)
    ...
    private var infoFlags: UInt32 {
        ...
        flags |= RDPClientInfoFlags.maximizeShell
...
private enum RDPClientInfoFlags {
    ...
    static let maximizeShell: UInt32 = 0x0000_0020
...
private enum RDPClientPerformanceFlags {
    static let disableWallpaper: UInt32 = 0x0000_0001
    static let disableFullWindowDrag: UInt32 = 0x0000_0002
    static let disableMenuAnimations: UInt32 = 0x0000_0004
    static let disableTheming: UInt32 = 0x0000_0008
    static let disableCursorShadow: UInt32 = 0x0000_0020
    static let disableCursorSettings: UInt32 = 0x0000_0040
    static let enableFontSmoothing: UInt32 = 0x0000_0080
    static let fastPath = disableWallpaper
